...
import { Search, BarChart3, History, LogOut, Menu, X, Target, Sun, Moon} from "lucide-react";import { useState } from "react";
...
export default function Navbar() {
    ...
    return (
        ...
        <nav 
            className={`fixed top-4 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl bg-background/70 backdrop-blur-[10px] z-50 border border-border shadow-lg transition-all duration-200 ${
        ...
        >
            ...
            {mobileOpen && (
                // <div className="md:hidden border-b border-border bg-background origin-top">
                  <div className="md:hidden bg-background origin-top rounded-b-3xl">
