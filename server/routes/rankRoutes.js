...
import { addKeyword, deleteKeyword, getKeyword, getKeywords, refreshKeyword, toggleTracking, compareCompetitor } from "../controllers/rankController.js";
...
rankRouter.post('/:id/compare', auth, compareCompetitor);
