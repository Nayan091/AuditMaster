...
const issueSchema = new mongoose.Schema({
  ...
  priority: { type: String, enum: ["Fix First", "Fix Soon", "Nice to Have"], default: "Fix Soon" },
  effort: { type: String, enum: ["Quick Fix", "Moderate", "Involved"], default: "Moderate" },
...
const analysisSchema = new mongoose.Schema({
  ...
  categories: {
    ...
    keywords: [
    {
        ...
        competitionLabel: { type: String, enum: ["Low", "Medium", "High"], default: "Medium" },
    },
],
issues: [issueSchema],
